describe('functions', () => {
  ...
  it('it returns \'fizz\' if input is divisible by 3, \'buzz\' if 5, \'fizzbuzz\' if 15, else the input', () => {
    let num = 0;
    ...
    expect(fizzBuzz(null)).toEqual(false);
    expect(fizzBuzz('foo')).toEqual(false);
